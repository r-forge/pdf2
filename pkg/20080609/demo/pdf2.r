...
###################################################
for(i in 1:10)
  pdf.box(i-0.1, i-0.1, i+0.1, i+0.1, LETTERS[i], link=F, border=c(0,0,0))
...
mtext("mtext test 3", outer=T, side = 1, url="http://www.bioconductor.org")
mtext("mtext test 4", outer=T, side = 4, cex=3, url="http://www.playstation.com")
